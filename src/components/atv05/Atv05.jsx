      ...
      <div className="bg-black w-fit h-fit rounded-2xl text-white">
        <div>
          <div className="flex justify-center">
            <input
              className="text-gray-200 bg-zinc-900 font-bold rounded-md mt-2 px-5 text-right w-4/5"
              type="text"
              value={getResult()}
              readOnly
            />
          ...
          <div className={classDivGrupo()}>
            <div className={classDivBotao()}>
              <button className="botao-calc-top" onClick={() => clear()}>
                A/C
              </button>
            </div>

            <div className={classDivBotao()}>
              <button className="botao-calc-top" onClick={() => plusMinus()}>
                ⁺∕₋
              </button>
            </div>

            <div className={classDivBotao()}>
              <button className="botao-calc-top" onClick={() => percent()}>
                %
              </button>
